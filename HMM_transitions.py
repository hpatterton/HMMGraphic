...
class HMM_transitions:
    ...
    def __init__(self, filepath, pseudocounts = False, sequence_conservation = False):  # should we calculate pseudocounts or raw ratios?
        self.sequence_array = []
        ...
        self.number_of_conserved_columns = self.make_column_category_list()
        self.transition_probabilities = [[0]*len(self.dictionary_of_transition_paths) for i in range(self.number_of_conserved_columns+1)]
    ...
    def calculate_transition_probabilities(self, profile_index, transition_numbers):
